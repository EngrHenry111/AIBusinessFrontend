      ...
      <div className="sf-page" style={{ maxWidth: 420 }}>
        <div className="sf-panel">
          <div style={{ textAlign: 'center', marginBottom: 16 }}>
            ...
            <h1 style={{ fontSize: '1.3rem', margin: '8px 0 0' }}>{mode === 'login' ? 'Log In' : 'Create an Account'}</h1>
          ...
          <form onSubmit={submit}>
            ...
            <button className="sf-btn" disabled={submitting}>{submitting ? 'Please wait…' : mode === 'login' ? 'Log In' : 'Create Account'}</button>
          </form>
